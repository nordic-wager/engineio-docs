...
<footer class="border-t border-white/[0.06] bg-zinc-950">
	<div class="mx-auto max-w-7xl px-4 py-12 lg:px-8">
		<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
			...
			<!-- Documentation -->
			<div>
				<h3 class="text-xs font-semibold tracking-wider text-zinc-400 uppercase">Documentation</h3>
			...
			<!-- Resources -->
			<div>
				<h3 class="text-xs font-semibold tracking-wider text-zinc-400 uppercase">Resources</h3>
				<ul class="mt-3 space-y-2">
			...
			<!-- Community -->
			<div>
				<h3 class="text-xs font-semibold tracking-wider text-zinc-400 uppercase">Community</h3>
				<ul class="mt-3 space-y-2">
					<li>
						<a
					...
					<li>
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							class="footer-link">Stake.com</a
						>
					</li>
					<li>
						<a href="https://stake.us" target="_blank" rel="noopener noreferrer" class="footer-link"
							>Stake.us</a
						>
					</li>
				</ul>
		...
		<!-- Bottom bar -->
		<div
			class="mt-10 flex flex-col items-center justify-between gap-3 border-t border-white/[0.04] pt-6 sm:flex-row"
		>
			...
			<div class="flex items-center gap-4">
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="text-zinc-600 transition-colors hover:text-[#5865F2]"
					aria-label="Discord"
				>
